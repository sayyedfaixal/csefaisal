        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className="flex flex-col justify-center h-full">
                <h2 className="text-4xl sm:text-7xl font-bold text-white">
                    I'm a <span className=' underline text-pink-600'>Mohammad Faisal Sayed</span>
                </h2>
                <p className=" text-[25px] text-fuchsia-500  py-10 max-w-md">
                <Typewriter
                    options={{
                        strings: ['A Front-end Web Developer.', '2 times GATE CSE Qualfied with AIR 2152 in 2022', 'Winner of Smart India Hackathon 2019.', 'A Curious Learner.'],
                        autoStart: true,
                        loop: true,
                        delay : 50
                      }}
