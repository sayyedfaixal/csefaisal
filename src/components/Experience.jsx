...
const Experience = () => {
  ...
  return (
    <div
      name="Experience"
      className="w-full h-screen bg-gradient-to-b from-black via-grey to-gray-800 "
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-6 text-center py-6 px-12 sm:px-0">
